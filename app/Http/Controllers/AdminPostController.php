...
class AdminPostController extends Controller
{
    ...
    public function index(){
        ...
        return view('admin.posts.Aindex', ['posts'=> $posts]);
    }

    public function show(Admin $post){
    ...
    public function create(){
        ...
        return view('admin.posts.Acreate',$data);
    }
    ...
    public function store(){
        ...
        auth()->user()->AdminPost()->create($inputs);
...
//        }
        $data['category'] = Category::where('status','active')->get();
        $data['post'] = $post;
        return view('admin.posts.Aedit', $data);
    }

    public function destroy(Admin $post ,Request $request){
    ...
    {
        $post = Admin::findorFail($request['id']);
        $post['status'] = "active";
