                    ...
                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                        ...
                        @foreach($posts as $post)
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('Apost.edit', $post->id)}}">{{$post->title}}</a></td>
                                <td>
...
{{--                                <td>{{$post->updated_at->diffForHumans()}}</td>--}}
                                <td class="text-center">
                                    ...
                                    <a class="btn btn-info" href="{{ route('Apost.edit',$post->id) }}" style="padding: 2px 10px"><i class="fa fa-edit"></i></a>
                                </td>
                            </tr>

                            <div id="myModal{{$post->id}}" class="fade modal modal-danger" role="dialog">
                                <form method="post" action="{{route('Apost.destroy', $post->id)}}" enctype="multipart/form-data" style="display: inline">
                                    @csrf
                                    @method('DELETE')
