    ...
    <x-home-master>
        ...
        @section('sidebar')
                        ...
                        <div class="card-2 p-4 mt-6">
                            ...
                            <div class="d-flex justify-content-center px-4">
                                <div class="search">
                                    ...
                                    <form class="form-db" method="get" action="/forum/search">
                            ...
                            <div class="row mt-4 g-1 px-4 mb-1 mt-3">
                                ...
                                <div class="col-md-2 ">
                                    ...
                                    <div class="border card-inner p-3 d-flex flex-column align-items-center"> <img  src="/storage/public/logo/laravel-2.svg" alt="" width="40">
                                        <div class="text-center mg-text"> <span class="mg-text"> <a href="{{ url('/forum/search') . '/' . $category->id }}"
            ...
            {{-- <div class="menu-wrap">
                <ul>
                    @foreach ($categories as $category)
                        <li> <a href="{{ url('/forum/search') . '/' . $category->id }}"
                                @if ($selected_category == $category->id) style="color: white;background-color:#343A40; padding: 0px 2px" @endif>{{ $category->name }}</a>
                        </li>
                    @endforeach
                </ul>
            </div> --}}
                    ...
                    <div class="row mt-5">
                        <div class="col-md-12 text-center">
                            <p class="copyright">
                                ...
                                </script>2022 All rights reserved | This template is made with <i
                                    class="ion-ios-heart" aria-hidden="true"></i> by <a href=""
                                    target="_blank">web.com</a>
                            </p>
                        </div>
                    </div>
                </div>
