...
Route::get('/Article', 'AdminHomeController@index')->name('ArticleHome');
Route::get('/Article/search/{id?}', 'AdminHomeController@search')->name('ArticleHome.search');
Route::get('/Article/{Article}', 'AdminHomeController@post_detail')->name('ArticlePost');
...
Route::prefix('admin','admin/home')->group(function(){
    ...
    Route::get('/posts/AdminCreate', 'AdminPostController@create')->name('Apost.create');
    ...
    Route::get('/Myposts', 'AdminPostController@index')->name('Apost.index');
    Route::patch('/Myposts/{post}/Aupdate', 'AdminPostController@update')->name('Apost.update');
    Route::get('/Myposts/{post}/Aedit', 'AdminPostController@edit')->name('Apost.edit');
    Route::post('/Aposts', 'AdminPostController@store')->name('Apost.store');
   Route::delete('/Myposts/{post}/Adestroy', 'AdminPostController@destroy')->name('Apost.destroy');
